 ...
 * Generated for Laravel 5.7.13 on 2019-01-11 10:57:15.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
         ...
         * @static
         */
        public static function formatDataObject($view)
        {
            return \App\Console\Kernel::formatDataObject($view);
        }
         ...
         * @static
         */
        public static function ceptIdentifiers()
        {
            return \App\Console\Kernel::ceptIdentifiers();
        }
         ...
         * @static
         */
        public static function invoicesGenerateDay()
        {
            return \App\Console\Kernel::invoicesGenerateDay();
        }
    ...
    class Request {
        ...
        {
            return  \Illuminate\Foundation\Providers\FormRequestServiceProvider($rules, $params);
        }
        ...
        {
            return \Illuminate\Foundation\Providers\FormRequestServiceProvider($absolute);
        }
